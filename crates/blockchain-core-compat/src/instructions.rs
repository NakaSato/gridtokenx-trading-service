...
pub fn build_mint_to_wallet_ix(
    ...
    let token_program_id =
        std::str::FromStr::from_str("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA").unwrap();
    ...
    let destination_ata =
        get_associated_token_address_with_program_id(&destination_owner, &mint_pda, &token_program_id);
