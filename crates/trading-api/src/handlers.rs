...
impl TradingService for TradingGrpcService {
    ...
    async fn cancel_order(
        ...
        let mut res = TradingResponse::default();
        res.success = success;
        res.message = if success { "Order cancelled" } else { "Order not found or already closed" }.to_string();
    ...
    async fn list_orders(
        ...
        let order_responses = orders.into_iter().map(|o| {
    ...
    async fn calculate_p2p_cost(&self, _ctx: Context, _req: OwnedView<CalculateP2PCostRequestView<'static>>) -> Result<(P2PTransactionCost, Context), ConnectError> {
        Ok((P2PTransactionCost::default(), _ctx))
    }
    async fn get_market_prices(&self, _ctx: Context, _req: OwnedView<trading_protocol::google::protobuf::EmptyView<'static>>) -> Result<(P2PMarketPrices, Context), ConnectError> {
    ...
    async fn get_blockchain_market_data(&self, _ctx: Context, _req: OwnedView<trading_protocol::google::protobuf::EmptyView<'static>>) -> Result<(BlockchainMarketDataResponse, Context), ConnectError> {
        Ok((BlockchainMarketDataResponse::default(), _ctx))
    }
    async fn get_market_stats(&self, _ctx: Context, _req: OwnedView<trading_protocol::google::protobuf::EmptyView<'static>>) -> Result<(MarketStatsResponse, Context), ConnectError> {
        Ok((MarketStatsResponse::default(), _ctx))
    }
    async fn get_matching_status(&self, _ctx: Context, _req: OwnedView<trading_protocol::google::protobuf::EmptyView<'static>>) -> Result<(MatchingStatusResponse, Context), ConnectError> {
        Ok((MatchingStatusResponse::default(), _ctx))
    }
    async fn get_settlement_stats(&self, _ctx: Context, _req: OwnedView<trading_protocol::google::protobuf::EmptyView<'static>>) -> Result<(SettlementStatsResponse, Context), ConnectError> {
